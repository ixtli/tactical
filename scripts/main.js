...
import EditorHUD from "./editor_hud.js";
import HUD from "./hud.js"; // jshint ignore:line
import { subscribe } from "./bus.js";
import generateFSM, { START } from "./state_machine.js";
import Chunk from "./map/chunk.js";
// noinspection JSFileReferences
import VersionInfo from "./build_info.js";
...
TacticalEngine.prototype.emitStyledBuildInfo = function () {
	...
	const style = "background-color: #0055FF; color: #BAFFEF;" + "border-radius: 1px;text-shadow: 1px 1px 2px #000000;";
	const hashStyle = "background-color: #0055FF; color: #FFF2B3;" + "border-radius: 1px";
	const dateStyle = "background-color: #0055FF; color: #FFF2B3;" + "border-radius: 1px";
	console.log(`%cTactical Engine [ Build %c${hash} %c@ %c${date} %c]`, style, hashStyle, style, dateStyle, style);
};