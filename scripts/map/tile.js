import TileBufferGeometry, { TILE_HEIGHT } from "../tile_geometry.js";
...
export default function Tile(name) {
  ...
  * @private
  */
	this._color = new THREE.BufferAttribute(new Float32Array(this._position.array.length), 3);
...
Tile.prototype.debugColor = function () {
	const debugColors = [new THREE.Color("red"), new THREE.Color("green"), new THREE.Color("blue"), new THREE.Color("black"), new THREE.Color("white"), new THREE.Color(0x999999)];
	let colorIndex = 0;
