import Chunk from "./chunk.js"; // jshint ignore:line
import TileBufferGeometry, { TILE_HEIGHT, TILE_WIDTH } from "../tile_geometry.js";
...
ChunkMesh.prototype._resizeBuffers = function (tileCount) {
	...
	if (oldVertexCount < vertexCount) {
		...
		console.log(`Allocating ${buffer} tiles. (${bufferVertexCount} verts, ` + buffer * VERT_COUNT * 4 * 3 / 1000000 + "mb)");
