import ChunkMesh, { MAX_CHUNK_DEPTH, MAX_CHUNK_HEIGHT, MAX_CHUNK_WIDTH } from "./chunk_mesh.js";
import { subscribe, unsubscribe } from "../bus.js";
import Tile from "./tile.js"; // jshint ignore:line
import TileDictionary from "./tile_dictionary.js";
...
Chunk.prototype.inBounds = function (vec) {
	...
	return !(vec.x >= this.width() || vec.y >= this.height() || vec.z >= this.width());
};
