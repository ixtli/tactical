 ...
 * list of contributors. Thank you all, you're awesome!
 */
...
TWEEN.Tween.prototype = assign(Object.create(Object.prototype), {
	...
	start: function start(time)
	{
		...
		for (var property in this._valuesEnd)
		{
			...
			if (this._valuesEnd[property] instanceof Array)
			{
				...
				// Create a local copy of the Array with the start value at the
				// front
			...
			// object, we should not set that property in the object
	...
	stopChainedTweens: function stopChainedTweens()
	{
		...
		for (var i = 0, numChainedTweens = this._chainedTweens.length;
				 i < numChainedTweens; i++)
		{
		...
		if (elapsed === 1)
		{
			...
			else
			{
				...
				for (var i = 0, numChainedTweens = this._chainedTweens.length;
						 i < numChainedTweens; i++)
				{
					// Make the chained tweens start exactly at the time they
					// should, even if the `update()` method was called way
					// past the duration of the tween
