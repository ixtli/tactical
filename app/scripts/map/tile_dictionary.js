...
{
	console.assert(this.indexForAttributes(newAttributes) ===
		-1, `attempt to update a duplicate tile ${newAttributes}`);
	...
	console.assert(this.indexForTile(tile) !==
		-1, `tile ${oldHash} does not exist`);
